...
function getLodop(oOBJECT, oEMBED,liscences) {
    ...
    try {
        ...
        if (needCLodop()) {
            ...
            if (!LODOP && CLodopJsState !== "complete") {
                if (CLodopJsState == "loading") console.log("网页还没下载完毕，请稍等一下再操作."); else alert("没有加载CLodop的主js，请先调用loadCLodop过程.");
                return;
            }
            if (!LODOP) {
                return;
